...
def get_columns():
    return [
        ...
        {"label": "Offload By", "fieldname": "offload_by_date", "fieldtype": "Data", "width": 100},
        {"label": "Drop By", "fieldname": "return_empty_by_date", "fieldtype": "Data", "width": 100},
        ...
        {"label": "Client Rate", "fieldname": "client_rate", "fieldtype": "Currency", "width": 100},
        {"label": "Transp Rate", "fieldname": "transporter_rate", "fieldtype": "Currency", "width": 100},
        {"label": "Pmt Terms", "fieldname": "payment_terms", "fieldtype": "Data", "width": 120},
...
def execute(filters=None):
    ...
    jobs = frappe.get_all(
        ...
        fields=[
            ...
            "load_by_date", "offload_by_date", "return_empty_by_date",
            "no_of_trucks_required", "trucks_confirmed",
            "client_rate", "transporter_rate", "payment_terms",
    ...
    for job in jobs:
        data.append({
            ...
            "load_by_date": format_date(job.get("load_by_date", "")),
            "offload_by_date": format_date(job.get("offload_by_date", "")),
            "return_empty_by_date": format_date(job.get("return_empty_by_date", "")),
            "no_of_trucks_required": job.get("no_of_trucks_required", 0),
            "trucks_confirmed": job.get("trucks_confirmed", 0),
            "client_rate": job.get("client_rate", 0),
            "transporter_rate": job.get("transporter_rate", 0),
