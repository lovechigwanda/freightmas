...
def execute(filters=None):
    ...
    for job in jobs:
        ...
        # Use stored dnd_start_date and storage_start_date from DB
        ...
        data.append([
            ...
            job.shipping_line,
            job.cargo_count,
            format_ddmmmyy(job.bl_received_date),
            format_ddmmmyy(job.bl_confirmed_date),
            format_ddmmmyy(job.discharge_date),
            format_ddmmmyy(job.sl_invoice_received_date),
            format_ddmmmyy(job.sl_invoice_payment_date),
            format_ddmmmyy(job.do_requested_date),
            format_ddmmmyy(job.do_received_date),
            format_ddmmmyy(job.port_storage_start_date),
            job.dnd_free_days,
            job.port_free_days,
            format_ddmmmyy(dnd_start_date),
            format_ddmmmyy(storage_start_date),
            dnd_days_total,
            storage_days_total,
        ])
...
def get_columns():
    return [
        ...
        {"label": "BL Rcvd", "fieldname": "bl_received_date", "fieldtype": "Data", "width": 95},
        {"label": "BL Conf", "fieldname": "bl_confirmed_date", "fieldtype": "Data", "width": 95},
        {"label": "Discharged", "fieldname": "discharge_date", "fieldtype": "Data", "width": 95},
        {"label": "SL Inv Rcvd", "fieldname": "sl_invoice_received_date", "fieldtype": "Data", "width": 95},
        {"label": "SL Inv Paid", "fieldname": "sl_invoice_payment_date", "fieldtype": "Data", "width": 95},
        {"label": "DO Reqsd", "fieldname": "do_requested_date", "fieldtype": "Data", "width": 95},
        {"label": "DO Rcvd Date", "fieldname": "do_received_date", "fieldtype": "Data", "width": 95},
        {"label": "Sto Start", "fieldname": "port_storage_start_date", "fieldtype": "Data", "width": 95},
        {"label": "DND Free Days", "fieldname": "dnd_free_days", "fieldtype": "Int", "width": 60},
        {"label": "Sto Free Days", "fieldname": "port_free_days", "fieldtype": "Int", "width": 60},
