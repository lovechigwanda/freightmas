...
frappe.query_reports["Clearing Job Profitability Report"] = {
    filters: [
        {
            ...
            on_change: function() {
                ...
                switch(date_range) {
                    ...
                    case "This Year":
                        ...
                        break;
                    case "Last Year":
                        // Fix: always use the last full calendar year
                        ...
                        break;
                    default:
                        // Custom or blank: don't override dates
                        from_date = frappe.query_report.get_filter_value('from_date');
                        to_date = frappe.query_report.get_filter_value('to_date');
                }

                // Only auto-set if not Custom or blank
