		...
		data.append(
			{
				...
				"est_revenue": row.get("est_revenue", 0),
...
def get_columns():
	return [
		...
		{"label": "Est. Revenue", "fieldname": "est_revenue", "fieldtype": "Currency", "width": 110},
		{"label": "Est. Cost", "fieldname": "est_cost", "fieldtype": "Currency", "width": 110},
		{"label": "Est. Profit", "fieldname": "est_profit", "fieldtype": "Currency", "width": 110},
