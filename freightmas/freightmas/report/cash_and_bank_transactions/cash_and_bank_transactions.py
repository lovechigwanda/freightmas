...
def export_excel(filters):
    ...
    file_bytes = build_excel_file(
        ...
        data=data,
        columns=columns,
        report_title="Cash and Bank Transactions",
        net_field_label="Net Balance",
    )
    send_excel_response(file_bytes, "Cash_and_Bank_Transactions.xlsx")
...
def export_pdf(filters):
    ...
    send_pdf_response(file_bytes, "Cash_and_Bank_Transactions.pdf")
