...
frappe.query_reports["Profit and Loss by Cost Center With Template"] = {
	filters: [
		{
			fieldname: "company",
			label: __("Company"),
...
function set_dates_from_fiscal_year() {
	...
	if (from_fiscal_year && to_fiscal_year) {
		frappe.call({
			method: "freightmas.freightmas.report.profit_and_loss_by_cost_center_with_template.profit_and_loss_by_cost_center_with_template.get_fiscal_year_data",
			args: {
