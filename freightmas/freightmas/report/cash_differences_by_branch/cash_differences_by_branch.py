...
def execute(filters=None):
	...
	data = frappe.db.sql(
		...
		SELECT
			...
			COUNT(DISTINCT cashier) AS cashier_count,
		...
		WHERE {conditions}
		GROUP BY branch
		ORDER BY ABS(SUM(difference)) DESC, branch
...
def get_columns(filters):
	...
	return [
		{"label": _("Branch / Station"), "fieldname": "branch", "fieldtype": "Data", "width": 180},
		{"label": _("Differences"), "fieldname": "difference_count", "fieldtype": "Int", "width": 100},
		{"label": _("Cashiers"), "fieldname": "cashier_count", "fieldtype": "Int", "width": 90},
...
def get_summary(data):
	return [
		{"label": _("Branches"), "value": len(data), "datatype": "Int", "indicator": "Blue"},
