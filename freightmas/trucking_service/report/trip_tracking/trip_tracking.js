...
frappe.query_reports["Trip Tracking"] = {
    "filters": [
        {
    ...
    "formatter": function (value, row, column, data, default_formatter) {
        ...
        // Highlight status column with color
        if (column.fieldname == "workflow_state" && data && data.workflow_state) {
            ...
            value = `<span style='color:${color}!important; font-weight:bold'>${value}</span>`;
        }
    ...
    "onload": function(report) {
        ...
        report.page.add_inner_button('Export to Excel', function() {
            ...
            const url = `/api/method/freightmas.api.export_report_to_excel?report_name=Trip Tracking&filters=${query}`;
            window.open(url);
        }, 'Export');
